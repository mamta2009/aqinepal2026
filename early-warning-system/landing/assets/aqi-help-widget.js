/**
 * Floating aqiHelp launcher — FAB + expandable panel.
 * Loads /help/aqi-help?embed=1 (chat UI only) in an iframe.
 * Skips itself when already on the aqiHelp page. Load: <script defer src="/landing-assets/aqi-help-widget.js"></script>
 */
(function () {
  if (
    !window.location.pathname ||
    window.location.pathname.replace(/\/$/, "") === "/help/aqi-help"
  ) {
    return;
  }
  ...
  var EMBED_SRC = "/help/aqi-help?embed=1";
  ...
  root.innerHTML =
    ...
    '<a class="aqi-help-panel-full" href="/help/aqi-help" target="_blank" rel="noopener" title="Open full aqiHelp page" aria-label="Open full aqiHelp page">' +
    '<svg class="aqi-help-panel-full-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">' +
    '<polyline points="15 3 21 3 21 9"></polyline><polyline points="9 21 3 21 3 15"></polyline>' +
    '<line x1="21" y1="3" x2="14" y2="10"></line><line x1="3" y1="21" x2="10" y2="14"></line>' +
    "</svg></a>" +
    '<button type="button" class="aqi-help-panel-close" aria-label="Close aqiHelp">✕</button>' +
    "</div></div>" +
    '<iframe class="aqi-help-panel-frame" src="' +
    EMBED_SRC +
    '" title="aqiHelp assistant"></iframe>' +
    "</div>";
  ...
  function injectCss() {
    ...
    s.textContent =
      ...
      ".aqi-help-panel-actions{display:flex;align-items:center;gap:8px;}" +
      ".aqi-help-panel-full{display:inline-flex;align-items:center;justify-content:center;width:34px;height:34px;border-radius:8px;border:1px solid #475569;background:#334155;color:#e2e8f0;text-decoration:none;}" +
      ".aqi-help-panel-full:hover{background:#475569;color:#6ee7b7;}" +
      ".aqi-help-panel-full:focus{outline:2px solid #6ee7b7;outline-offset:2px;}" +
      ".aqi-help-panel-full-icon{display:block;}" +
  ...
  panelEl
    .querySelector(".aqi-help-panel-close")
