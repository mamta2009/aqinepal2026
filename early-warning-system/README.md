...
- **Guides:** [`docs/guides/`](docs/guides/) — start with [`APPLICATION_OVERVIEW.md`](docs/guides/APPLICATION_OVERVIEW.md), [`DATA_FETCHING.md`](docs/guides/DATA_FETCHING.md), [`ALERTS_AND_NOTIFICATIONS.md`](docs/guides/ALERTS_AND_NOTIFICATIONS.md), and [`IMPLEMENTATION_SNAPSHOT.md`](docs/guides/IMPLEMENTATION_SNAPSHOT.md)
