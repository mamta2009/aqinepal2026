        ...
        {learning.map((guide) => (
          <ResourceCard
            ...
            resource={{
              ...
              title: guide.title,
              description:
                guide.summary || "Open this practical Climate Compass resource.",
      ...
      {technical.length ? (
        <section className="mt-20">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {technical.map((guide) => (
              <Card key={guide.path} className="flex flex-col">
                <BookOpen aria-hidden="true" className="mb-4 size-6 text-forest" />
