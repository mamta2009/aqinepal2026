...
import { getClimateGuidance } from "@/helpers/climate-guidance";
import { briefAirMeasurement, explainAirMeasurement } from "@/helpers/pm25-aqi";
import { extractRainIndicator } from "@/helpers/weather-rain";
...
export default function HomeScreen() {
  ...
  return (
    <TabScreen
      ...
      <View className="mb-1 flex-row items-center gap-3 px-4">
        <DrawerMenuButton />
